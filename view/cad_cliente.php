...
<head>
    <meta charset="utf-8" />
    <title>Novo Cliente • Projeto Registro</title>
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <link rel="stylesheet" href="../style.css">
</head>
<body>
    <header>
        <h1>Cadastro de Cliente (Responsável)</h1>
    ...
    <div class="wrap">
        ...
        <section class="card">
            <form action="../controller/control_cliente.php" method="POST">
                <div style="display: grid; gap: 15px;">
                    ...
                    <div style="display: flex; gap: 15px;">
                        ...
                        <div style="flex: 1;">
                            <label class="muted" style="display:block; margin-bottom:5px;">RG</label>
                            <input type="text" name="rg" required style="width:100%; padding:10px; background:#0b1220; border:1px solid var(--line); color:white; border-radius:8px;">
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: 15px;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <input type="text" name="telefone" required style="width:100%; padding:10px; background:#0b1220; border:1px solid var(--line); color:white; border-radius:8px;">
                        </div>
                    </div>

                    <div style="display: flex; gap: 15px;">
                        <div style="flex: 2;">
                            <label class="muted" style="display:block; margin-bottom:5px;">Endereço Residencial</label>
                            <input type="text" name="endereco" placeholder="Rua, número, complemento" required style="width:100%; padding:10px; background:#0b1220; border:1px solid var(--line); color:white; border-radius:8px;">
                        </div>
                        <div style="flex: 1;">
                            <label class="muted" style="display:block; margin-bottom:5px;">CEP</label>
                            <input type="text" name="cep" placeholder="00000-000" required style="width:100%; padding:10px; background:#0b1220; border:1px solid var(--line); color:white; border-radius:8px;">
                        </div>
                    </div>
