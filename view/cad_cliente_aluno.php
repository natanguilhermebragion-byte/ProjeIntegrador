...
<head>
    ...
    <style>
        ...
        label { font-size: 12px; margin-left: 5px; color: var(--muted); }
        input, select { width:100%; padding:10px; background:#0b1220; border:1px solid var(--line); color:white; border-radius:8px; margin-top:5px; outline: none; transition: 0.3s; }
        input:focus { border-color: #3b82f6; }
        .btn-submit { margin-top:30px; background: #2563eb; color: white; border: none; padding: 15px; border-radius: 8px; cursor: pointer; font-weight: 700; width:100%; font-size:16px; transition: 0.3s; }
...
<body>
    <header>
        ...
        <a href="../index.php" style="color: var(--txt); text-decoration: none;">← Voltar ao Painel</a>
    </header>
        ...
        <form action="../controller/control_combinado.php" method="POST">
            ...
            <section class="card">
                ...
                <div>
                    ...
                    <input type="text" name="NomeCompleto" placeholder="Nome completo do responsável" required>
                </div>
                <div class="grid-2">
                    <div>
                        <label>CPF</label>
                    ...
                    <div>
                        <label>RG</label>
                        <input type="text" name="rg" maxlength="12" placeholder="00.000.000-0" required>
                    </div>
                </div>
                <div class="grid-2">
                    <div>
                ...
                <div style="margin-top: 20px; padding-top: 15px; border-top: 1px dashed var(--line);">
                    ...
                    <input type="text" name="nome_segundo_resp" placeholder="Outro contato de emergência">
                </div>
                <div class="grid-2">
                    <div>
                ...
                <div style="margin-top: 10px;">
                    ...
                    <input type="text" name="complemento" id="complemento" placeholder="Ex: Apto 12, Bloco B">
                </div>
            </section>
            ...
            <section class="card" style="margin-top:20px;">
                ...
                <div class="grid-2">
                    <div style="flex: 2;"><label>Nome da Criança</label><input type="text" name="nomeAluno" required></div>
                ...
                <div class="grid-2">
                    ...
                    <div><label>Série</label><input type="text" name="serie" placeholder="Ex: 5º Ano"></div>
                    <div><label>Sala</label><input type="text" name="sala" placeholder="Ex: B2"></div>
                </div>
            ...
            <section class="card" style="margin-top:20px; border: 1px solid #334155;">
                ...
                <div class="grid-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="qtdParcela" id="qtdParcela" value="12" min="1" oninput="calcularDataTermino()" required>
                    </div>
                </div>
                ...
                <div style="margin-top: 15px;">
                    ...
                    <input type="date" name="dataFinalContrato" id="dataFinal" readonly style="background: rgba(255,255,255,0.05); color: #94a3b8; cursor: not-allowed;">
                </div>
    ...
    // CÁLCULO AUTOMÁTICO DE TÉRMINO DO CONTRATO
    function calcularDataTermino() {
        ...
        if (inputInicio && qtdParcelas > 0) {
            ...
            // Calcula o mês final baseado na quantidade de parcelas
    ...
    document.querySelectorAll('input').forEach(($input) => {
        ...
        $input.addEventListener('input', (e) => {
            if (field.includes('cpf')) e.target.value = masks.cpf(e.target.value);
            if (field.includes('telefone') || field.includes('tel')) e.target.value = masks.tel(e.target.value);
            if (field.includes('cep')) e.target.value = masks.cep(e.target.value);
        }, false);
    });
    </script>
</body>
